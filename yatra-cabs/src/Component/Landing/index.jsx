        ...
        <div className='bg-image-on-landing'>
          <div className='dark-image-background'>
            ...
            <div className='tag-line-wrapper'>
              <h1 className='tag-line-first-item'>​India's <span className='tag-line-bold'>Leading One-Way Inter-City </span> Cab Service Provider</h1>
                <p > <p className=' tag-line-bold-1'></p> </p>
